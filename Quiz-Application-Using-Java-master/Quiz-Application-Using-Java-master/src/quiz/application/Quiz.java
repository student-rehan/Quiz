...
public class Quiz extends JFrame implements ActionListener {
    ...
    Quiz(String name) {
        ...
        image.setBounds(00, 00, 1440, 400);
        add(image);
        
        qno = new JLabel();
        qno.setBounds(100, 450, 50, 30);
        qno.setFont(new Font("Halion", Font.PLAIN, 24));
        qno.setBackground(new Color(30, 144, 255));
        qno.setForeground(Color.WHITE);
        add(qno);
        
        question = new JLabel();
        question.setBounds(150, 450, 900, 30);
        question.setFont(new Font("Halion", Font.PLAIN, 24));
        question.setBackground(new Color(30, 144, 255));
